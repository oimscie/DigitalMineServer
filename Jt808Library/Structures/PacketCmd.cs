...
namespace JtLibrary.Structures
{
    ...
    public struct JT808Cmd
    {
        ...
        /// CAN 总线数据上传应答
        /// </summary>
        public const UInt16 RSP_0705 = 0x0705;
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct JT1078Cmd
    {
        /// <summary>
        /// 终端资源列表
        /// </summary>
        public const UInt16 RSP_1205 = 0x1205;

        /// <summary>
        ///终端音视频参数
        /// </summary>
        public const UInt16 RSP_1003 = 0x1003;
        ...
        ///历史音视频请求
        /// </summary>
        public const UInt16 REQ_9201 = 0x9201;
    }

    [StructLayout(LayoutKind.Sequential)]
    public struct AcSafeCmd
    {
        /// <summary>
        /// 报警附件上传指令
        /// </summary>
        public const UInt16 REQ_9208 = 0x9208;

        /// <summary>
        /// 文件上传完成回复
        /// </summary>
        public const UInt16 REQ_9212 = 0x9212;

        /// <summary>
        /// 报警附件信息消息
        /// </summary>
        public const UInt16 RSP_1210 = 0x1210;

        /// <summary>
        /// 文件信息上传消息
        /// </summary>
        public const UInt16 RSP_1211 = 0x1211;

        /// <summary>
        /// 文件信息上传完成消息
        /// </summary>
        public const UInt16 RSP_1212 = 0x1212;
    }
    ...
    public struct JT809Cmd
    {
        ...
        #endregion UP_EXG_MSG 主链路动态信息交换消息
        ...
        #endregion DOWN_EXG_MSG 从链路动态信息交换消息
        ...
        #endregion UP_PLATFORM_MSG 主链路平台间信息交互消息
        ...
        #endregion DOWN_PLATFORM_MSG 从链路平台间信息交互消息
        ...
        #endregion UP_WARN_MSG 主链路平台间信息交互消息
        ...
        #endregion DOWN_WARN_MSG 从链路报警信息交互消息
        ...
        #endregion UP_CTRL_MSG 主链路车辆监管消息
        ...
        #endregion DOWN_CTRL_MSG 从链路车辆监管消息
        ...
        #endregion UP_BASE_MSG 主链路静态信息交换消息
        ...
        #endregion DOWN_BASE_MSG 从链路静态信息交换消息
