...
namespace ActionSafe.AcSafe_Su.PacketBody
{
    public class PacketBody
    {
        ...
        /// </summary>
        [StructLayout(LayoutKind.Sequential)]
        public struct DriveHelpWarnBody
        {
            /// <summary>
            /// 报警ID
            /// </summary>
        ...
        /// </summary>
        [StructLayout(LayoutKind.Sequential)]
        public struct DriverStateWarnBody
        {
            /// <summary>
        ...
        /// </summary>
        [StructLayout(LayoutKind.Sequential)]
        public struct TirePressureBody
        {
            /// <summary>
            /// 报警 ID,按照报警先后，从 0 开始循环累加，不区分报警类型
            /// </summary>
            ...
            /// 报警/事件信息列表
            /// </summary>
            public List<TirePressureEventlistBody> TirePressure_Event_list;
        ...
        /// </summary>
        [StructLayout(LayoutKind.Sequential)]
        public struct TirePressureEventlistBody
        {
            /// <summary>
        ...
        /// </summary>
        [StructLayout(LayoutKind.Sequential)]
        public struct BlindAreaWarnBody
        {
            /// <summary>
            /// 报警 ID,按照报警先后，从 0 开始循环累加，不区分报警类型
            /// </summary>
